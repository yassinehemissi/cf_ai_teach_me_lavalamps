...
- Treat `vibe/CODING_RULES.MD` as the source of truth for architecture, editing limits, UI structure, simulation boundaries, and prompt logging.
- Treat `vibe/PLAN.MD` as the active project roadmap and keep new work aligned with its phase boundaries.
